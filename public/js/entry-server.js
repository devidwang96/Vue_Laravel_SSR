...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(26), __webpack_require__(98).setImmediate))
...
var routes = [{
    ...
    name: 'app-index',
    component:  false ? function (resolve) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__additional_plugins_ServerXHR__ = __webpack_require__(51);
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* default */].Store({
    state: {
        Laravel: Laravel,
        backend_data: {},
        ServerXHR: __WEBPACK_IMPORTED_MODULE_2__additional_plugins_ServerXHR__["a" /* default */]
    },
    getters: {
        Laravel: function Laravel(state) {
    ...
    mutations: {
        change_backend_data: function change_backend_data(state, data) {
            __WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(state.backend_data, data.route_name, data.backend_data);
        }
    },

    actions: {
        change_backend_data: function change_backend_data(_ref, data) {
...
Component.options.__file = "/home/rinzler/Desktop/sites/vue_laravel_cms/resources/assets/js/main/components/App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3a876157", Component.options)
  } else {
    hotAPI.reload("data-v-3a876157", Component.options)
  }
})()}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main_app__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__main_router__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_store__ = __webpack_require__(28);
...
new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
    ...
    __WEBPACK_IMPORTED_MODULE_3__main_router__["a" /* router */].push(url);

    __WEBPACK_IMPORTED_MODULE_3__main_router__["a" /* router */].onReady(function () {
        var matchedComponents = __WEBPACK_IMPORTED_MODULE_3__main_router__["a" /* router */].getMatchedComponents();
        ...
        __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a.all(matchedComponents.map(function (Component) {
            if (Component.backend_created) {
                return Component.backend_created(__WEBPACK_IMPORTED_MODULE_3__main_router__["a" /* router */], __WEBPACK_IMPORTED_MODULE_4__main_store__["a" /* store */], Component);
            }
        })).then(function () {
            resolve(__WEBPACK_IMPORTED_MODULE_2__main_app__["a" /* default */]);
        }).catch(reject);
    }, reject);
}).then(function (app) {
    renderVueComponentToString(app, function (err, res) {
        if (err) print(err);else {
            print(res);
            print("<script>window.__INITIAL_STATE__= " + __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(__WEBPACK_IMPORTED_MODULE_4__main_store__["a" /* store */].state) + "</script>");
        }
    });
}).catch(function (err) {
    print(err);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuex_router_sync__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue__ = __webpack_require__(24);
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_vuex_router_sync__["sync"])(__WEBPACK_IMPORTED_MODULE_1__store__["a" /* store */], __WEBPACK_IMPORTED_MODULE_2__router_index__["a" /* router */]);

/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_4_vue___default.a({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_router__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_resource__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vee_validate__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_the_mask__ = __webpack_require__(111);
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('app-header', __webpack_require__(103));

__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('app-footer', __webpack_require__(102));

__WEBPACK_IMPORTED_MODULE_4_vee_validate__["a" /* Validator */].extend('truthy', {
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('app', __webpack_require__(46));

var eventHub = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a();
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.mixin({
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            _this.animateNodes = $('.animate');
            _this.charAnimateNodes = $('.char-animate');
            _this.mouseMoveAnimateNodes = $('.mouse-move-animate');
            _this.scrollMotionAnimateNodes = $('.scroll-motion-animate');

            _this.mouseMoveAnimateNodes.each(function () {
                $(this).attr('data-offset-x', -$(this).offset().left);
                $(this).attr('data-offset-y', $(this).offset().top);
            });

            _this.scrollMotionAnimateNodes.each(function () {
                $(this).attr('data-offset-y', $(this).offset().top);
            });
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
        ...
        mouseMoveAnimate: function mouseMoveAnimate(screenX, screenY) {
            this.mouseMoveAnimateNodes.each(function () {
                var sensivity = $(this).data('sensivity');
    ...
    }, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_vuex__["a" /* mapActions */])(['change_backend_data', 'changeStoreReady', 'handleStoreErrorResponse', 'handleStoreError', 'changeStoreRequestIsBeingSent', 'changeStoreAPIRequestIsBeingSent'])),
    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_vuex__["b" /* mapGetters */])(['Laravel', 'state']))
});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(26), __webpack_require__(96)))
...
Component.options.__file = "/home/rinzler/Desktop/sites/vue_laravel_cms/resources/assets/js/main/components/Pages/404.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0665a723", Component.options)
  } else {
    hotAPI.reload("data-v-0665a723", Component.options)
  }
})()}
...
Component.options.__file = "/home/rinzler/Desktop/sites/vue_laravel_cms/resources/assets/js/main/components/Parts/Footer.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1240de04", Component.options)
  } else {
    hotAPI.reload("data-v-1240de04", Component.options)
  }
})()}
...
Component.options.__file = "/home/rinzler/Desktop/sites/vue_laravel_cms/resources/assets/js/main/components/Parts/Header.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-337341f6", Component.options)
  } else {
    hotAPI.reload("data-v-337341f6", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0665a723", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-1240de04", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-337341f6", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3a876157", module.exports)
  }
}
